...
/*   Updated: 2023/10/14 19:30:54 by mayache-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Phonebook::search_contact(void)
{
	...
	while (j < contact_number && j < 8)
	{
		...
		if (contact[j].getFirst_Name().length() > 10)
			std::cout << std::setw(10) << contact[j].getFirst_Name().substr(0, 9) + "." << "|";
		else
			std::cout << std::setw(10) << contact[j].getFirst_Name() << "|";
		if (contact[j].getLast_Name().length() > 10)
			std::cout << std::setw(10) << contact[j].getLast_Name().substr(0, 9) + "." << "|";
		else
			std::cout << std::setw(10) << contact[j].getLast_Name()<< "|";
		if (contact[j].getNick_Name().length() > 10)
			std::cout << std::setw(10) << contact[j].getNick_Name().substr(0, 9) + "." << "|";
		else
			std::cout << std::setw(10) << contact[j].getNick_Name() << "|";
		std::cout << std::endl;
		j++;
	}
	std::cout << "-----------------------------------------------" << std::endl;
